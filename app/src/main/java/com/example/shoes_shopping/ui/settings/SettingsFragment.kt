...
import com.example.shoes_shopping.databinding.FragmentSettingsBinding
...
class SettingsFragment : BaseFragment(), View.OnClickListener {
    ...
    override fun initEvents() {
        ...
        (view?.findViewById(R.id.toolbar_setting) as Toolbar).setNavigationOnClickListener {
    ...
    private fun showDialog(
        ...
        if (dialogId == R.layout.dialog_change_pass) {
            ...
            textInputDialog3.hint = resources.getString(R.string.retype_password)
